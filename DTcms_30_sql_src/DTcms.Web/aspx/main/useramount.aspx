...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append(" \r\n        <dd>\r\n          <input name=\"payment_id\" type=\"radio\" value=\"" + Utils.ObjectToStr(dr["id"]) + "\" /> " + Utils.ObjectToStr(dr["title"]) + "\r\n        </dd>\r\n        ");
	}	//end for if
	...
	templateBuilder.Append(" <!--取得一个DataTable-->\r\n      ");
	string pagelist1 = get_page_link(10, page, totalcount, "useramount", action, "__id__");
