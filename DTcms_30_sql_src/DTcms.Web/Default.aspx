<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="DTcms.Web.Default" %>
    ...
    <div id="contpar" class="contpar">
        ...
        <div class="cont cont1">
            <div class="png videopar" id="videopar">
                <div class="video">
                    <ul style="left: 0px;">
                        <li>
                            <img src="/web/images/wenzi_01.png" alt="旭贝尔">
                    </ul>
                </div>
            </div>
        </div>
        <div class="cont cont2">
            <div class="img0" id="cont2_img0">
                <img class="png" src="/web/images/wenzi_02.png" alt="旭贝尔"></div>
        </div>
        <div class="cont cont3">
            <div class="img8_consub1" id="cont3_img8">
                <img class="png" src="/web/images/wenzi_03.png" alt="旭贝尔"></div>
        </div>
        <div class="cont cont4">
            <div class="img0" id="cont4_img0">
                <img class="png" src="/web/images/wenzi_04.png" alt="旭贝尔"></div>
