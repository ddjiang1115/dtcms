<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BrokerageCheck.aspx.cs" Inherits="DTcms.Web.admin.SellerManage.BrokerageCheck" %>
...
<div class="line10"></div>
    ...
    <script>
        ...
        $('#list_data').datagrid({
            ...
            fit: false,//自动大小 
            fitColumns: true,
            url: '/ashx/BrokerageCheck.ashx?type=select',
            //sortName: 'code', 
            //sortOrder: 'desc', 
            remoteSort: false,
            idField: 'PromotionID',
            ...
            //}, '-',
            {
                ...
                handler: function () {
                    ...
                    $.ajax({
                        url: "/ashx/BrokerageCheck.ashx?type=up&ids=" + parm,
                        success: function (msg) {
                            //重新加载当前页
                            $('#list_data').datagrid('reload');
                        }
