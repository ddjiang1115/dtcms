...
namespace DTcms.DAL
{
    ...
    public partial class manager
    {
        ...
        /// 查询手机号码是否存在
        /// </summary>
        public bool ExistsMobile(string telephone)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from " + databaseprefix + "manager");
        ...
        public int Add(Model.manager model)
        {
            ...
            strSql.Append("role_id,role_type,user_name,password,salt,real_name,telephone,email,is_lock,add_time,companyname,name,position,phone,address,alipayaccount)");
            ...
            SqlParameter[] parameters = {
                    ...
                    new SqlParameter("@alipayaccount", SqlDbType.NVarChar,100)};
            ...
            parameters[15].Value = model.Alipayaccount;
