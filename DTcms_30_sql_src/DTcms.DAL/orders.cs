...
namespace DTcms.DAL
{
    ...
    public partial class orders
    {
        ...
        /// <returns></returns>
        public DataSet GetList(string orderid)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append(@"select a.img_url,g.goods_id from  dt_order_goods g with(nolock) 
join dt_article a with(nolock) on g.goods_id=a.id
